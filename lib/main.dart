...
class _BackgroundPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width / 2, size.height / 2), 310, ringPaint);
    canvas.drawCircle(Offset(size.width / 2, size.height / 2), 390, ringPaint);
  }
...
class _PhonePedestal extends StatelessWidget {
  const _PhonePedestal();
